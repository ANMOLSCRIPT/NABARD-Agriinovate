...
import 'price_discovery_page_model.dart';
export 'price_discovery_page_model.dart';

class PriceDiscoveryPageWidget extends StatefulWidget {
  const PriceDiscoveryPageWidget({super.key});

  @override
  State<PriceDiscoveryPageWidget> createState() =>
      _PriceDiscoveryPageWidgetState();
}

class _PriceDiscoveryPageWidgetState extends State<PriceDiscoveryPageWidget>
    with TickerProviderStateMixin {
  late PriceDiscoveryPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PriceDiscoveryPageModel());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color(0xFF2BFF00),
          automaticallyImplyLeading: false,
          title: Text(
            FFLocalizations.of(context).getText(
              'fenw5198' /* Price Discovery */,
            ),
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                              ...
                              image: CachedNetworkImageProvider(
                                'https://images.unsplash.com/photo-1481988535861-271139e06469?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxzdW5zZXR8ZW58MHx8fHwxNzIzMDYzMTQ0fDA&ixlib=rb-4.0.3&q=80&w=1080',
                              ),
                            ),
                            borderRadius: BorderRadius.circular(12.0),
                          ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'pn42aoyl' /* Here we will show overview of ... */,
                        ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '684b3vb1' /* Here we will Display Agricultu... */,
                        ),
                        style: FlutterFlowTheme.of(context).labelLarge.override(
                              fontFamily: 'Readex Pro',
                              letterSpacing: 0.0,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'wl6cz7jh' /* Here headline and the content ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'ukjlhmnq' /* Here headline and the content ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
