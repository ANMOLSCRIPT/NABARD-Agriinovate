...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.homeWeather = await WeatherAPICall.call();

      if (!(_model.homeWeather?.succeeded ?? true)) {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          child: Stack(
                            children: [
                              Align(
                                alignment: const AlignmentDirectional(-0.17, -1.0),
                                child: InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                                  hoverColor: Colors.transparent,
                                ...
                                child: InkWell(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      fadeOutDuration:
                                          const Duration(milliseconds: 500),
                                      imageUrl: WeatherAPICall.weatherImage(
                                        (_model.homeWeather?.jsonBody ?? ''),
                                      )!,
                                      width: 300.0,
                                      height: 170.0,
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '7r5s2u0n' /* Here we will show overview of ... */,
                        ),
                                      ...
                                      children: [
                                        Hero(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              'https://images.unsplash.com/photo-1659346895020-cde86bdff11a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxiZWF1dGlmdWwlMjBvY2VhbnxlbnwwfHx8fDE3MjMwNjIwMjd8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                              width: double.infinity,
                                              height: 220.0,
                                              fit: BoxFit.cover,
                                            ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '7y1wkm7e' /* Here we will Display Agricultu... */,
                        ),
                        style: FlutterFlowTheme.of(context).labelLarge.override(
                              fontFamily: 'Readex Pro',
                              letterSpacing: 0.0,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'c2xip8ng' /* Here headline and the content ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'kpylkaen' /* Here headline and the content ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
