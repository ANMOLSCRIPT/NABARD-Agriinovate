...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AboutWeatherNews',
          path: '/aboutWeatherNews',
          builder: (context, params) => const AboutWeatherNewsWidget(),
        ),
        FFRoute(
          name: 'AboutPriceAnalyticsMarketTrends',
          path: '/aboutPriceAnalyticsMarketTrends',
          builder: (context, params) => const AboutPriceAnalyticsMarketTrendsWidget(),
        ),
        FFRoute(
          name: 'AboutNegotiatingTools',
          path: '/aboutNegotiatingTools',
          builder: (context, params) => const AboutNegotiatingToolsWidget(),
        ),
        FFRoute(
          name: 'AboutCommunityPage',
          path: '/aboutCommunityPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'MarketTrendsPage')
              : const MarketTrendsPageWidget(),
        ),
        FFRoute(
          name: 'auth_2_Create',
          path: '/auth2Create',
        ...
        FFRoute(
          name: 'NegotiatingToolsPage',
          path: '/negotiatingToolsPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'NegotiatingToolsPage')
              : const NegotiatingToolsPageWidget(),
        ),
        FFRoute(
          name: 'Settings',
          path: '/settings',
        ...
        FFRoute(
          name: 'WeatherPage',
          path: '/weatherPage',
          builder: (context, params) => const WeatherPageWidget(),
        ),
        FFRoute(
          name: 'chat_2_Details',
          path: '/chat2Details',
